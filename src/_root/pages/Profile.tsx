      ...
      <div className="profile-inner_container">
        <div className="flex xl:flex-row flex-col max-xl:items-center flex-1 gap-7">
          ...
          <div className="flex flex-col flex-1 justify-between md:mt-2">
            ...
            <p className="small-medium md:base-medium text-center xl:text-left mt-2 max-w-screen-sm">
              {currentUser.bio}
            </p>
          </div>
          ...
          <div className="flex justify-center gap-4">
            <div className={`${user.id !== currentUser.$id && "hidden"}`}>
              <Link
                ...
                className={`h-12 edit-profile px-5 text-white flex-center gap-2 rounded-lg ${
      ...
      {currentUser.$id === user.id && (
        <div className="flex max-w-5xl w-full gap-5">
          ...
          <Link
            ...
            className={`profile-tab rounded ${
              pathname === `/profile/${id}/liked-posts` && "!bg-[#363636]"
            }`}
          >
            <img
